...
export const routes: Routes = [
  ...
  },
  {
    ...
    canActivate: [authGuard],
    loadComponent: () =>
      import('./features/purchase/ticket-purchase/ticket-purchase.component').then(
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'history',
        loadComponent: () =>
          import('./features/profile/event-history/event-history.component').then(
            (m) => m.EventHistoryComponent,
          ),
      },
      {
        path: 'history/:performanceId/performance',
        loadComponent: () =>
          import('./features/performance/performance-detail/performance-detail.component').then(
