...
@Component({
  ...
  template: `
    <div
      class="min-h-[calc(100vh-4rem)] flex items-center justify-center p-4 relative overflow-hidden"
    >
      <!-- Background elements -->
      <div
        class="absolute top-[-10%] left-[-10%] w-96 h-96 bg-primary/20 rounded-full blur-[100px] pointer-events-none"
      ></div>
      <div
        class="absolute bottom-[-10%] right-[-10%] w-96 h-96 bg-accent/20 rounded-full blur-[100px] pointer-events-none"
      ></div>

      <div
        class="w-full max-w-md bg-surface-elevated/80 backdrop-blur-xl border border-white/10 rounded-3xl shadow-2xl p-8 relative z-10"
      >
        <div class="text-center mb-8">
          <h1
            class="text-4xl font-black mb-2 text-transparent bg-clip-text bg-gradient-to-r from-primary to-white tracking-tight"
          >
            Bentornato
          </h1>
            ...
            <div class="relative">
              ...
              <div class="relative">
                ...
                <button
                  ...
                  class="absolute right-3 top-3 text-text-secondary hover:text-white transition-colors"
                >
        ...
        <div class="mt-8 text-center text-sm text-text-secondary">
          ...
          <a
            ...
            class="text-primary hover:text-white font-medium transition-colors"
            >Registrati ora</a
          >
        </div>
      </div>
